$(document).ready(getSupportoTecnico());

function getSupportoTecnico(){

    $.ajax({
        method: "POST",
        crossDomain: true, //localhost purposes
        url: "php/getAssistenza_SupportoTecnicoConfigurazione.php", //Relative or absolute path to file.php file
