$(document).ready(function(){
    ...
    $("#heading").load("TimHeading.html", function () {
        ...
        $("#my_breadcrumb").html("<li><a href='Assistenza.html'>Assistenza</a></li><li><a href='Assistenza_MaxiCategorie.html?linea_servizi'>Gestione linea e servizi</a></li><li>Tutti i modi per ricaricare</li>");
    });
    getID();
});
